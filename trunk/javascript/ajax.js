...
function ajax_form_submit(form_id, update_id, submit_url, after, after_update, after_url){
    ...
    var ajax = new Ajax.Updater(update_id, submit_url, {method: 'post', parameters: post, onSuccess: function() { ajax_update(after_update,after_url); new Effect.BlindDown(after_update);} } );
    document.getElementById(update_id).style.display = 'block';
