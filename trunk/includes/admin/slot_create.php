<?php
/*
 * $Id: slot_create.php 16 2010-03-09 10:24:59Z maidenfan $
...
if (isset($_POST['submit'])) {
    ...
    $new_slot = array(
                    'time_start'    => sprintf("%02d:%02d:00",
                                                clean_string($_POST['start_time_h']),
                                                clean_string($_POST['start_time_m'])),
                    'time_end'      => sprintf("%02d:%02d:00",
                                                clean_string($_POST['end_time_h']),
                                                clean_string($_POST['end_time_m'])),
